...
def Home():
    ...
    modules = {
        ...
        "tools": [
            ...
            {"title": "Trip Planner ✈️", "desc": "Plan your next trip with AI-generated itineraries and recommendations.", "href": "/tools/trip-planner", "history": "Trip Planner was added as the project expanded its scope. It uses AI to generate personalized travel plans, and clever mathematical flight route image generation."},
        ],
        "fun": [
            ...
            {"title": "Playlist Maker 🎶", "desc": "Get song suggestions based on your preferences", "href": "/fun/playlist-maker", "history": "Playlist Maker was added as the project grew. It uses AI to generate playlists, and is the first module to use an authenticated API."},
